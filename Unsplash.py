...
class unsplash():
    ...
    def display_photo(self , photo_id):
        ...
        # Display the photo
        display(Image(self , url=photo_image_url))

        # Display the attribution text
        display(HTML(f'Photo on <a target="_blank" href="https://unsplash.com/photos/{photo_id}">Unsplash</a> '))
        print()

    def search_unsplash(self , search_query, photo_features, photo_ids, results_count):
        
        # Encode the search query
        text_features = self.encode_search_query(search_query)

        # Find the best matches
        best_photo_ids = self.find_best_matches(text_features, photo_features,
...
if __name__ == "__main__":
    unsplash = unsplash()
    print(unsplash.doStuff("should i buy the iphone 13 or pixel 6"))
